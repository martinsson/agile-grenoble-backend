...
(def db-spec "postgresql://localhost:5432/sessions")
(jdbc/db-do-commands db-spec (jdbc/drop-table-ddl :sessions))
...
(for [session-map (map extractor @h/smaps)] (jdbc/insert! db-spec :sessions session-map))